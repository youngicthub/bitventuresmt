            ...
            <div class="pb-3 row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                   ...
                   <div class=" shadow  login-page roundedd border-1 ">
                        <div class="card-body">
                            <h4 class="text-center card-title" style="color:#69e2b0 !important">Create new password</h4>
                            ...
                            <form method="POST" action="{{ route('password.update') }}"  class="mt-4 login-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#69e2b0 !important">Password Confirmation<span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="key" class="fea icon-sm icons"></i>
                                    ...
                                    <div class="mb-0 col-lg-12">
                                        <button class="btn btn-primary btn-block pad" style="background-color:#69e2b0 !important" type="submit">Reset Password</button>
                                    </div>
                                    <!--end col-->
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0"><small class="mr-2 text-dark" style="color:#69e2b0 !important">&copy; Copyright  {{date('Y')}} &nbsp; {{$settings->site_name}} &nbsp; All Rights Reserved.</small>
                                        </p>
                                    </div>
                                </div>
                                <!--end row-->

...
@extends('layouts.app')
    ...
    @foreach($total_withdrawals as $withdrawn)
                                            @if(!empty($withdrawn->count))
                                            <h5 class="mb-1 text-{{$text}}"><b>{{$settings->currency}}{{ number_format($withdrawn->count, 2, '.', ',')}}</b></h5>
                                            @else
                                            <h5 class="mb-1 text-{{$text}}">{{$settings->currency}}0.00</h5> 
                                            @endif
                                        @endforeach
    
    <small class="text-muted text-{{$text}}">Total Withdrawals now</small>
</div>
